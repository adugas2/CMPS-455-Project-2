...
public class MyThreadACL extends Thread{
    private int id;
    ...
    public MyThreadACL(int id, int numDomains, int numObjects, int domain, String[] objectList, Semaphore[] mutex, String[] objects) {
    ...
    public static void arbitrator(int id, int domain, int request, int action){
        ...
        if (action == 0) {
            ...
            if (objectList[request].contains("D" + (domain+1) + ":R")) {
            ...
            if (objectList[request].contains("D" + (domain+1) + ":R/W") || objectList[request].contains("D" + (domain+1) + ":W")) {
    ...
    public static void arbitrator(int id, int domain, int request){
        ...
        if (objectList[switchNum + numObjects].contains("D" + domain + ":allow")) {
            domain = switchNum;
